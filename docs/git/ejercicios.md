...
1. Crear un repositorio vació en modo local
2. Configuar git con tus nombre de usuario, mail y servidor proxy
3. Crear 2 ramas llamadas `personal` y `compartida`
4. En la rana `master`, crear el archivo `test1.txt`, `test2.txt` y `test3.txt`. Confirmar después de cada creación de archivo.
