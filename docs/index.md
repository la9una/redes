...
* **Ubuntu Desktop 18.04.2 LTS** 
	* Torrent: [[64 bits]](http://releases.ubuntu.com/18.04/ubuntu-18.04.2-desktop-amd64.iso.torrent) 
	* ISO: [[64 bits]](http://releases.ubuntu.com/18.04.2/ubuntu-18.04.2-desktop-amd64.iso)
* **Ubuntu Server 18.04.2 LTS** 
	* Torrent: [[64 bits]](http://releases.ubuntu.baehost.com/18.04.2/ubuntu-18.04.2-live-server-amd64.iso.torrent)
	* ISO: [[64 bits]](http://releases.ubuntu.com/18.04.2/ubuntu-18.04.2-live-server-amd64.iso)
