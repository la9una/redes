...
!!! tip "Comandos de gestión de Apache"
		Existen otros comandos ofrecidos por el servidor para gestionar diversas tareas y que podés encontrar en una sección anterior llamada [Gestión básica del servidor](gestionBasica.md#gestion-general-del-servidor). 
...
* [Empleando el archivo hosts de cada equipo](../dns/archivoHosts.md)
