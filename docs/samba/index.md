Samba es un servidor para computadoras con GNU/Linux, Mac OS X o Unix que permite **administrar y compartir recursos en redes de computadoras con Microsoft Windows** como:
